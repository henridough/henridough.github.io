        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <Button
              ...
              className="text-gray-300 hover:text-green-500 hover:bg-gray-800"
            >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black border-t border-gray-800">
              {navItems.map((item) => (
                <button
                  key={item.name}
                  onClick={() => scrollToSection(item.href)}
                  className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-green-500 transition-colors duration-300"
                >
                  {item.name}
                </button>
              ))}
